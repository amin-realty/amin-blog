...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    locale: 'zh_TW',
    type: 'website',
    images: [{ url: 'https://amin-blog.vercel.app/agent.jpg', width: 800, height: 600, alt: '敏姊房產通部落格' }],
  },
}
...
export default function SharePage() {
  return (
    <div style={{ textAlign: 'center', padding: '80px 24px', fontFamily: 'sans-serif' }}>
      ...
      <h1 style={{ fontSize: '1.5rem', fontWeight: 900, color: '#1a1a2e', marginBottom: 8 }}>敏姊房產通 房產知識部落格</h1>
      <p style={{ color: '#6b7280', marginBottom: 24 }}>買房、賣房、節稅、投資，敏姊幫你搞懂每一步！</p>
